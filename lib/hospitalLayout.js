export const hospitalLayout = {
  ...
  first: [
    // ===== B2 FIRST FLOOR =====
    {
      block: "B2",
      zones: [
        { title: "Zone F-1 - Twin 1", beds: ["F1","F2"], columns: 2 },
        { title: "Zone F-2 - Twin-2", beds: ["F3","F4"], columns: 2 },
        { title: "Zone F-3 - Delux", beds: ["F5"], columns: 1 },
        { title: "Zone F-4 - Single 2", beds: ["F6"], columns: 1 },
        { title: "Zone F-5 - Twin 3", beds: ["F7","F8"], columns: 2 },
        { title: "Zone F-6 - Triple 2", beds: ["F9","F10","F11"], columns: 3 },
      ]
    },
