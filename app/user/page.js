...
function UserDashboardContent() {
  ...
  }, [checkAccess, fetchPatients, fetchDoctors])
  ...
  const handleShiftOut = async (patient) => {
    ...
    showToast(`${patient.name} shifted out to hospital`, "warning")
    setSelectedPatient(null)
    fetchPatients()
  }
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#020617", color: "#f8fafc" }}>
      <Navbar role="user" activeView={activeView} onViewChange={setActiveView} />
      ...
      <main style={{ padding: "24px", maxWidth: "1600px", margin: "0 auto" }}>
        ...
        {/* View 4: Shifted Out / Hospital Care */}
        {activeView === "hospital" && (
            ...
            >
              <div>
                ...
                <p style={{ margin: "4px 0 0 0", fontSize: "13px", color: "#94a3b8" }}>
                  Patients currently in external hospital care.
                </p>
              </div>
              <span
                style={{
